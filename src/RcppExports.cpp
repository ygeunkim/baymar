...
// sim_mar
std::vector<Eigen::MatrixXd> sim_mar(int num_sim, int num_burn, Eigen::SparseMatrix<double> init, Eigen::MatrixXd row_coef, Eigen::MatrixXd col_coef, Eigen::MatrixXd row_sig, Eigen::MatrixXd col_sig);
RcppExport SEXP _baymar_sim_mar(SEXP num_simSEXP, SEXP num_burnSEXP, SEXP initSEXP, SEXP row_coefSEXP, SEXP col_coefSEXP, SEXP row_sigSEXP, SEXP col_sigSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(sim_mar(num_sim, num_burn, init, row_coef, col_coef, row_sig, col_sig));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_baymar_sim_mar", (DL_FUNC) &_baymar_sim_mar, 7},
    {NULL, NULL, 0}
};
